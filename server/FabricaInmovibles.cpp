...
FabricaInmovibles::FabricaInmovibles() {
	...
	for(tinyxml2::XMLElement* inmovible = 
		inmovibles->FirstChildElement("INMOVIBLE"); 
		inmovible != NULL; 
		inmovible = inmovible->NextSiblingElement("INMOVIBLE")) {
...
Bloque* FabricaInmovibles::getBloque(int tipo, double x, double y, 
									 std::string id) {
...
Bandera* FabricaInmovibles::getBandera(int tipo, double x, double y, 
									   std::string id) {
...
Inmovible* FabricaInmovibles::getInmovible(int tipo, double x, double y, 
										   std::string id) {
	if (tipo == 0)
