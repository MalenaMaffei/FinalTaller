...
void Juego::inicializarEdificios(int tipo, tinyxml2::XMLElement* padre, 
	...
	tinyxml2::XMLElement* edificiosXML = 
								padre->FirstChildElement(nombreXML.c_str());
	tinyxml2::XMLElement* edificioXML = 
								edificiosXML->FirstChildElement("EDIFICIO");
...
void Juego::inicializarInmovibles(int tipo, tinyxml2::XMLElement* padre, 
  	...
  	tinyxml2::XMLElement* inmoviblesXML = 
								padre->FirstChildElement(nombreXML.c_str());
	tinyxml2::XMLElement* inmovibleXML = 
						inmoviblesXML->FirstChildElement(nombreObjetos.c_str());
