...
La creación de spritesheets fue un proceso tedioso y largo, mucho más de lo que se había previsto inicialmente. Se tomo un enfoque pragmático, al principio solo había una sola imagen para todos los robots y otra para todos los vehículos, de a poco se fueron agregando las imágenes particulares, pero faltaron algunos vehículos.
